...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<main class="${"svelte-u9qvfs"}"><h1 class="${"svelte-u9qvfs"}">${escape(pageName)}!</h1>
    <p>Welcome this is my <b>${escape(pageName)}</b></p>
</main>`;
});
...
let pageName$1 = "About Page";

const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	$$result.css.add(css$1);

	return `<main class="${"svelte-u9qvfs"}"><h1 class="${"svelte-u9qvfs"}">${escape(pageName$1)}!</h1>
    <p>Welcome this is my <b>${escape(pageName$1)}</b></p>
</main>`;
});
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${validate_component(Router, "Router").$$render($$result, { url }, {}, {
	   ...
	   ${validate_component(Link, "Link").$$render($$result, { to: "about" }, {}, { default: () => `About` })}</nav>
