...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<main class="${"svelte-u9qvfs"}"><h1 class="${"svelte-u9qvfs"}">${escape($_("home.pageName"))}</h1>
    <p>${$_("home.welcome")}</p>
</main>`;
});
...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<main class="${"svelte-u9qvfs"}"><h1 class="${"svelte-u9qvfs"}">${escape($_("about.pageName"))}</h1>
    <p>${$_("about.welcome")}</p>
</main>`;
});
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `${validate_component(Router, "Router").$$render($$result, { basepath, url }, {}, {
			default: () => `${validate_component(NavigationBar, "NavigationBar").$$render($$result, {}, {}, {})}
		<div>${validate_component(Route, "Route").$$render($$result, { path: "about" }, {}, {
