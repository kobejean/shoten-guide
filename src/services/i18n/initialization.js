 ...
 */
const getClientPathname = () => process.browser && location.pathname
 ...
 * @return {string} Returns the user language
 */
const getClientUserLanguage = () =>
  process.browser && (navigator.language || navigator['userLanguage'])
...
const getUserLanguage = req =>
  getClientUserLanguage() || getServerUserLanguage(req)
